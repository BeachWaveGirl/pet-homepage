...
const Index = () => {
  return <div className="min-h-screen flex flex-col bg-background font-inter">
      <Header />
      ...
      <section className="w-full pt-16 relative">
        ...
        <div className="w-full relative">
          <img src="/assets/hero-memorial.png" alt="Pet Memorial - Rainbow Bridge with beloved pets in ornate baroque frame" className="w-full h-auto object-contain" />
      ...
      <section id="memorial-section" className="w-full py-16 px-4 bg-aged-paper paper-texture paper-vignette relative">
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {memorialOfferings.map(offering => <Link to={offering.link} key={offering.id} className="group">
