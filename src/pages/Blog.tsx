            ...
            {blogPosts.map((post) => (
              ...
              >
                <div className="aspect-[4/3] overflow-hidden relative">
                  ...
                  />
                  {/* Rainbow overlay */}
                  <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/10 via-pink-500/5 to-amber-500/10 opacity-60 group-hover:opacity-80 transition-opacity" />
                </div>
                <div className="p-6">
                  ...
                  <h2 className="font-playfair text-xl font-semibold text-white mb-3 group-hover:text-amber-400 transition-colors leading-tight line-clamp-2">
                    {post.title}
                  </h2>
                  ...
                  <div className="mt-4 flex items-center text-amber-400 text-sm font-medium group-hover:gap-2 transition-all">
      ...
      <section className="py-16 px-4 border-t border-gray-800/50">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/"
              className="inline-flex items-center justify-center px-8 py-3 bg-amber-500 text-black font-medium rounded-full hover:bg-amber-400 transition-colors"
            >
